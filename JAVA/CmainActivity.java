...
public class CmainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile = findViewById(R.id.button_cprofile);
...
// Check if the user is not verified
        ...
        profile.setOnClickListener(v -> {
            // Navigate to Pharmacist Registration
            Intent intent = new Intent(CmainActivity.this, CustomerProfileActivity.class);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                fuser.reload().addOnCompleteListener(task -> {
                    if (fuser.isEmailVerified()) {
                        Toast.makeText(CmainActivity.this, "Email Verified! Redirecting...", Toast.LENGTH_SHORT).show();
                        redirectToCustomerHome();
    ...
    private void redirectToCustomerHome() {
        Intent intent = new Intent(CmainActivity.this, CustomerHome.class);
